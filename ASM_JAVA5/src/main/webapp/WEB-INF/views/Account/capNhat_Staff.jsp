        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form:form name="my-form" action="/capNhat_Staff" method="POST" modelAttribute="cs">
	                                 ...
	                                 <div class="col-md-6 mt-1" id="gender">
										<div class="form-check form-check-inline">
										 	<label class="form-check-label" for="admin">Admin</label>
										  	<form:radiobutton class="form-check-input ml-2" id="admin" name="admin" value="true" path="admin"/>
										</div>
										<div class="form-check form-check-inline">
											<label class="form-check-label" for="staff">Staff</label>
										  	<form:radiobutton class="form-check-input ml-2" id="staff" name="admin" value="false" path="admin"/>							  
										</div>
									</div>
								</div>	
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label for="nid_number" class="col-md-4 col-form-label text-md-right">Password To Confirm</label>
                                    <div class="col-md-6">
