                        ...
                        <div class="card-body">
                            <form:form name="my-form" action="" method="POST" modelAttribute="cs">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                       <form:input type="text" id="full_name" class="form-control" path="customerName"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                         <form:input type="date" placeholder='YYYY-MM-DD' pattern="(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31))"
